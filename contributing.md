# Contributing to reshape-expressions

Hello there! First of all, thanks for being interested in reshape-expressions and helping out. We all think you are awesome, and by contributing to open source projects, you are making the world a better place. That being said, there are a few ways to make the process of contributing code to reshape-expressions smoother, detailed below:
